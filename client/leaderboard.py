    ...
    def draw(self, win):
        ...
        for i, score in enumerate(scores):
            ...
            pygame.draw.rect(win, color,
                             ( self.x, self.y + i * self.HEIGHT_ENTRY, self.WIDTH, self.HEIGHT_ENTRY), 0)
            ...
            win.blit(name, self.x + self.WIDTH/2 - name.get_width()/2, self.y + i * self.HEIGHT_ENTRY + 10)

            score = self.score_font.render(score[1], 1, (0, 0, 0))
            win.blit(score, self.x + self.WIDTH/2 - name.get_width()/2, self.y + i * self.HEIGHT_ENTRY + 10)
