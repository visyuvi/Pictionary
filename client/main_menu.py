"""Show the main menu for the game, gets the username before starting"""
...
class MainMenu:
    ...
    def draw(self):
        ...
        self.title = self.title_font.render("Pictionary!", 1, (0, 0, 0))
        ...
        if self.waiting:
            ...
            self.win.blit(enter, (self.WIDTH / 2 - self.title.get_width() / 2, 800))
        else:
